      ...
      <div class="settings-pane">
        ...
        <div class="settings-card">
          <table>
            ...
            <tr ${process.platform === "darwin" ? "" : "hidden"}>
              <td>
                <kbd>Option</kbd> + <kbd>${cmdOrCtrl}</kbd> + <kbd>H</kbd>
              </td>
        ...
        <div class="settings-card">
          <table>
            ...
            <tr ${process.platform === "darwin" ? "" : "hidden"}>
              <td>
                <kbd>Control</kbd> + <kbd>${cmdOrCtrl}</kbd> + <kbd>F</kbd>
              </td>
            ...
            <tr ${process.platform === "darwin" ? "" : "hidden"}>
              <td>
                <kbd>Option</kbd> + <kbd>${cmdOrCtrl}</kbd> + <kbd>I</kbd>
              </td>
            ...
            <tr ${process.platform === "darwin" ? "" : "hidden"}>
              <td>
                <kbd>Option</kbd> + <kbd>${cmdOrCtrl}</kbd> + <kbd>U</kbd>
              </td>
